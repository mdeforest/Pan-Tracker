...
export function PanCard({
  ...
  return (
    <button
      ...
      disabled={isEmpty}
      className={cn(
        "relative flex w-full items-center gap-3 rounded-2xl bg-card p-3 text-left shadow-sm",
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full text-xl",
